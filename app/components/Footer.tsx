...
export default function Footer() {
  ...
  return (
    <footer style={{ backgroundColor: "#E6B800", borderTop: "4px solid #e61f3e" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "3.5rem clamp(24px, 5vw, 48px) 2rem" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: "3rem", marginBottom: "3rem" }} className="footer-grid">
          ...
          <div>
            <div style={{ fontFamily: "var(--font-playfair)", fontSize: "1.4rem", fontWeight: 700, color: "#e61f3e", marginBottom: "0.75rem" }}>
              Crema<span style={{ color: "#e61f3e" }}>Paraíso</span>
            </div>
          ...
          <nav aria-label="Navegación del pie de página">
            <p style={{ fontFamily: "var(--font-jakarta)", fontSize: "0.65rem", fontWeight: 700, letterSpacing: "0.16em", textTransform: "uppercase", color: "#e61f3e", marginBottom: "1.25rem" }}>
              Navegación
            </p>
              ...
              {[
                ...
                <li key={item.href}>
                  <a
                    ...
                    onMouseEnter={(e) => (e.currentTarget.style.color = "#e61f3e")}
